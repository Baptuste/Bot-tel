...
try {
  ...
  check('16 notifs "confirmee"', countText('est confirmee') === 16);
  ...
  check('14 notifs "a ete livree"', countText('a ete livree') === 14);
  check('16 notifs "Ton livreur : <nom>"', countText('Ton livreur : ') === 16);
  check('2 notifs d\'annulation (no-shows)', countText('a ete annulee') === 2);
